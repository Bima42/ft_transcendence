<template>
  ...
  <script setup lang="ts">
	import ChatTypeBox from './ChatTypeBox.vue';
  </script>
  ...
  #chat .chat-tab {
	...
	padding: 5px 10px;
	margin-left: 10px;
	box-shadow: 3px 3px 5px rgba(255, 0, 128, 0.5); /* Pink shadow */
  }
  ...
  #chat .chat-sidebar .chat-users {
	list-style: none;
	margin: 0;
	padding: 0;
  }

  #chat .chat-sidebar .chat-user {
	display: flex;
	align-items: center;
	margin-bottom: 10px;
  }

  #chat .chat-sidebar .chat-user .chat-user-avatar {
	border-radius: 50%;
	width: 50px;
	height: 50px;
	margin-right: 10px;
  ...
  #chat .chat-sidebar .chat-user .chat-user-username {
	font-weight: bold;
  }
